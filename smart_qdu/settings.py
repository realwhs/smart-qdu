#coding:utf-8
# Django settings for smart_qdu project.
import os
...
if ENV == "sae":
    ...
    DATABASES = {
        'default': {
        'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': "smart",                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': "root",
        'PASSWORD': "root",
        'HOST': "",                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = 'os+%*yldoyp936k#-=7t@lfxr86bd2yap=#nvh7u2jnb@a*#wp'
...
ROOT_URLCONF = 'smart_qdu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'smart_qdu.wsgi.application'
